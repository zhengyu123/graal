...
public final class RuntimeReflection {
    ...
    public static void register(Class<?>... classes) {
        ImageSingletons.lookup(RuntimeReflectionSupport.class).register(ConfigurationPredicate.DEFAULT_CONFIGRATION_PREDICATE, classes);
    }
    ...
    public static void register(Executable... methods) {
        ImageSingletons.lookup(RuntimeReflectionSupport.class).register(ConfigurationPredicate.DEFAULT_CONFIGRATION_PREDICATE, methods);
    }
    ...
    public static void register(Field... fields) {
        ImageSingletons.lookup(RuntimeReflectionSupport.class).register(ConfigurationPredicate.DEFAULT_CONFIGRATION_PREDICATE, false, fields);
    }
