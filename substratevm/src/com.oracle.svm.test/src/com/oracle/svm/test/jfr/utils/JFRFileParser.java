...
public class JFRFileParser {
    ...
    static {
        ...
        supportedConstantPools.put(JfrTypes.GCName.getId(), new GCNameConstantPoolParser());
        supportedConstantPools.put(JfrTypes.GCCause.getId(), new GCCauseConstantPoolParser());
    }
